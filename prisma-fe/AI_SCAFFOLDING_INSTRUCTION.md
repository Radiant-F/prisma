...
### 5) React Router generated types (.react-router/types)

These files are generated by React Router tooling and should be committed as-is. Use them as reference for route typing and server build types.

#### .react-router/types/+routes.ts (example)
...
#### .react-router/types/+server-build.d.ts (example)
