...
const translations = {
  en: {
    ...
    homeGreetingFallbackName: "there",
    homeSearchPlaceholder: "Search tasks...",
    homeInitialsFallback: "ME",

    todoTitleRequired: "Title is required.",
    todoDescriptionTooLong: "Description is too long.",
    todoTitlePlaceholder: "Add a new task...",
    todoDescriptionPlaceholder: "Add description (optional)",
    todoDueLabel: "Due",
    todoTagsLabel: "Tags",
    todoPriorityLabel: "Priority",
    todoAdding: "Adding...",
    todoAddTask: "Add Task",
    todoNoTags: "No tags yet.",
    todoSubtasksLabel: "Subtasks",
    todoRemove: "Remove",
    todoNewSubtaskPlaceholder: "New subtask",
    todoAdd: "Add",
    todoLoading: "Loading tasks...",
    todoEmpty: "No tasks yet. Add your first one above.",
    todoEditTaskTitle: "Edit task",
    todoTaskTitlePlaceholder: "Task title",
  ...
  id: {
    ...
    homeGreeting: "Selamat pagi",
    homeGreetingFallbackName: "di sana",
    homeSearchPlaceholder: "Cari tugas...",
    homeInitialsFallback: "SAYA",

    todoTitleRequired: "Judul wajib diisi.",
    todoDescriptionTooLong: "Deskripsi terlalu panjang.",
    todoTitlePlaceholder: "Tambah tugas baru...",
    todoDescriptionPlaceholder: "Tambah deskripsi (opsional)",
    todoDueLabel: "Jatuh tempo",
    todoTagsLabel: "Tag",
    todoPriorityLabel: "Prioritas",
    todoAdding: "Menambahkan...",
    todoAddTask: "Tambah Tugas",
    todoNoTags: "Belum ada tag.",
    todoSubtasksLabel: "Subtugas",
    todoRemove: "Hapus",
    todoNewSubtaskPlaceholder: "Subtugas baru",
    todoAdd: "Tambah",
    todoLoading: "Memuat tugas...",
    todoEmpty: "Belum ada tugas. Tambahkan yang pertama di atas.",
    todoEditTaskTitle: "Edit tugas",
    todoTaskTitlePlaceholder: "Judul tugas",
    todoDescriptionLabel: "Deskripsi",
    todoDueDateLabel: "Tanggal jatuh tempo",
    todoCancel: "Batal",
    todoSaving: "Menyimpan...",
    todoSaveChanges: "Simpan perubahan",
    todoPageLabel: "Halaman",
    todoOfLabel: "dari",
    todoPrev: "Sebelumnya",
    todoNext: "Berikutnya",
    todoEdit: "Ubah",
